...
public class BubbleValue {
    ...
    public boolean equals(Object o) {
        ...
        return color == that.color && darkenColor == that.darkenColor && Float.compare(that.diffX, diffX) == 0 && Float.compare(that.diffY, diffY) == 0 && Float.compare(that.diffZ, diffZ) == 0 && Float.compare(that.originX, originX) == 0 && Float.compare(that.originY, originY) == 0 && Float.compare(that.originZ, originZ) == 0 && Float.compare(that.x, x) == 0 && Float.compare(that.y, y) == 0 && Float.compare(that.z, z) == 0 && Arrays.equals(label, that.label) && shape == that.shape;
