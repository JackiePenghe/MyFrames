...
public class Viewport implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        return Float.floatToIntBits(bottom) == Float.floatToIntBits(other.bottom) && Float.floatToIntBits(left) == Float.floatToIntBits(other.left) && Float.floatToIntBits(right) == Float.floatToIntBits(other.right) && Float.floatToIntBits(top) == Float.floatToIntBits(other.top);
    }
