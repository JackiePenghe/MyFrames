...
public class SubcolumnValue {
    ...
    public boolean equals(Object o) {
        ...
        return color == that.color && darkenColor == that.darkenColor && Float.compare(that.diff, diff) == 0 && Float.compare(that.originValue, originValue) == 0 && Float.compare(that.value, value) == 0 && Arrays.equals(label, that.label);
