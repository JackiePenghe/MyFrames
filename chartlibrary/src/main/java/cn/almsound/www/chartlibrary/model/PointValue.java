...
public class PointValue {
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.diffX, diffX) == 0 && Float.compare(that.diffY, diffY) == 0 && Float.compare(that.originX, originX) == 0 && Float.compare(that.originY, originY) == 0 && Float.compare(that.x, x) == 0 && Float.compare(that.y, y) == 0 && Arrays.equals(label, that.label);
